...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None, num_partitions=2, num_replicas=1):
        self.name = name
        ...
        #
        #
        topic_name = f"com.udacity.transit.station.{station_name}"  # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
